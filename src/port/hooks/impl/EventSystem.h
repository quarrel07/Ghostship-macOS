...
#define REGISTER_EVENT(eventType) eventType##ID = EventSystem_RegisterEvent()

#define REGISTER_LISTENER(eventType, priority, callback) EventSystem_RegisterListener(eventType##ID, callback, priority)
