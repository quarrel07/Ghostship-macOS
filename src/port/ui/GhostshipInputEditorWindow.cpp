...
GhostshipInputEditorWindow::~GhostshipInputEditorWindow() {
}

void GhostshipInputEditorWindow::InitElement() {
...
void GhostshipInputEditorWindow::UpdateElement() {
...
void GhostshipInputEditorWindow::DrawAnalogPreview(const char* label, ImVec2 stick, float deadzone, bool gyro) {
...
void GhostshipInputEditorWindow::DrawInputChip(const char* buttonName, ImVec4 color = CHIP_COLOR_N64_GREY) {
    ImGui::BeginDisabled();
...
void GhostshipInputEditorWindow::DrawButtonLineAddMappingButton(uint8_t port, N64ButtonMask bitmask) {
...
void GhostshipInputEditorWindow::DrawButtonLineEditMappingButton(uint8_t port, N64ButtonMask bitmask, std::string id) {
...
void GhostshipInputEditorWindow::DrawStickSection(uint8_t port, uint8_t stick, ImVec4 color = CHIP_COLOR_N64_GREY) {
    static int8_t sX, sY;
...
void GhostshipInputEditorWindow::UpdateBitmaskToMappingIds(uint8_t port) {
...
void GhostshipInputEditorWindow::UpdateStickDirectionToMappingIds(uint8_t port) {
...
void GhostshipInputEditorWindow::DrawRemoveRumbleMappingButton(uint8_t port, std::string id) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void GhostshipInputEditorWindow::DrawAddRumbleMappingButton(uint8_t port) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
bool GhostshipInputEditorWindow::TestingRumble() {
    return mRumbleTimer != INT32_MAX;
}

void GhostshipInputEditorWindow::DrawRumbleSection(uint8_t port) {
...
void GhostshipInputEditorWindow::DrawRemoveLEDMappingButton(uint8_t port, std::string id) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void GhostshipInputEditorWindow::DrawAddLEDMappingButton(uint8_t port) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void GhostshipInputEditorWindow::DrawLEDSection(uint8_t port) {
    for (auto [id, mapping] :
...
void GhostshipInputEditorWindow::DrawRemoveGyroMappingButton(uint8_t port, std::string id) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void GhostshipInputEditorWindow::DrawAddGyroMappingButton(uint8_t port) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void GhostshipInputEditorWindow::DrawGyroSection(uint8_t port) {
    auto mapping =
...
void GhostshipInputEditorWindow::addButtonName(N64ButtonMask mask, const char* name) {
...
void GhostshipInputEditorWindow::DrawDeviceToggles(uint8_t portIndex) {
    ImGui::PushItemFlag(ImGuiItemFlags_Disabled, true);
...
void GhostshipInputEditorWindow::DrawClearAllButton(uint8_t portIndex) {
...
void GhostshipInputEditorWindow::DrawPortTab(uint8_t portIndex) {
...
void GhostshipInputEditorWindow::DrawPortTabContents(uint8_t portIndex) {
...
void GhostshipInputEditorWindow::DrawSetDefaultsButton(uint8_t portIndex) {
    ImGui::SameLine();
...
void GhostshipInputEditorWindow::DrawFullContents() {
...
void GhostshipInputEditorWindow::DrawElement() {
    DrawFullContents();
}

void GhostshipInputEditorWindow::OffsetMappingPopup() {
